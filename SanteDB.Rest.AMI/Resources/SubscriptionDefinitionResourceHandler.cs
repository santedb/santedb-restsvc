...
namespace SanteDB.Rest.AMI.Resources
{
    ...
    public class SubscriptionDefinitionResourceHandler : ResourceHandlerBase<SubscriptionDefinition>
    {
        ...
        /// </summary>
        public SubscriptionDefinitionResourceHandler(ILocalizationService localizationService, IRepositoryService<SubscriptionDefinition> repositoryService, ISubscriptionExecutor subscriptionExecutor = null, IFreetextSearchService freetextSearchService = null) : base(localizationService, repositoryService, subscriptionExecutor, freetextSearchService)
        {
        }
