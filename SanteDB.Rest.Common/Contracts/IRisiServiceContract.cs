...
namespace SanteDB.Rest.RISI
{
    ...
    [ServiceKnownResource(typeof(ReportDefinition))]
    [ServiceKnownResource(typeof(ReportParameter))]
    [ServiceKnownResource(typeof(AutoCompleteSourceDefinition))]
    [ServiceKnownResource(typeof(RisiCollection<ReportFormat>))]
    [ServiceKnownResource(typeof(RisiCollection<ReportParameter>))]
