...
namespace SanteDB.Rest.Common.Behavior
{
    ...
    /// </summary>
    internal class SecurityPolicyEnforcementBehavior : IServiceBehavior, IEndpointBehavior, IOperationBehavior, IOperationPolicy
    {
    ...
    /// </summary>
    public SecurityPolicyEnforcementBehavior(Type behaviorType)
    {
