...
namespace SanteDB.Rest.OAuth.Docker
{
    /// <summary>
    ...
    public class OauthDockerFeature : IDockerFeature
    {
        ...
        public void Configure(SanteDBConfiguration configuration, IDictionary<string, string> settings)
        {
            ...
            if (oauthConf == null)
            {
                oauthConf = DockerFeatureUtils.LoadConfigurationResource<OAuthConfigurationSection>("SanteDB.Rest.OAuth.Docker.OauthFeature.xml");
