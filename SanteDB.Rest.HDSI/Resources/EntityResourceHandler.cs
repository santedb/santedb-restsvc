...
namespace SanteDB.Rest.HDSI.Resources
{
    ...
    public class EntityResourceHandler : EntityResourceHandlerBase<Entity>
    {
        ...
        /// DI constructor
        /// </summary>
        public EntityResourceHandler(ILocalizationService localizationService, IRepositoryService<Entity> repositoryService, IAuditService auditService, IFreetextSearchService freetextSearchService = null) : base(localizationService, repositoryService, auditService, freetextSearchService)
        {
        }
