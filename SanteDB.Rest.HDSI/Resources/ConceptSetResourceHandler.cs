...
namespace SanteDB.Rest.HDSI.Resources
{
    ...
    public class ConceptSetResourceHandler : HdsiResourceHandlerBase<ConceptSet>
    {
        ...
        /// DI constructor
        /// </summary>
        public ConceptSetResourceHandler(ILocalizationService localizationService, IRepositoryService<ConceptSet> repositoryService, IAuditService auditService, IFreetextSearchService freetextSearchService = null) : base(localizationService, repositoryService, auditService, freetextSearchService)
        {
        }
