...
namespace SanteDB.Rest.HDSI.Resources
{
    ...
    public class EntityExtensionResourceHandler : HdsiResourceHandlerBase<EntityExtension>
    {
        /// <summary>
        /// DI Constructor
        /// </summary>
        public EntityExtensionResourceHandler(ILocalizationService localizationService, IRepositoryService<EntityExtension> repositoryService, IResourceCheckoutService resourceCheckoutService, ISubscriptionExecutor subscriptionExecutor, IFreetextSearchService freetextSearchService = null) : base(localizationService, repositoryService, resourceCheckoutService, subscriptionExecutor, freetextSearchService)
        {
        }
