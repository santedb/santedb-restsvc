        ...
        public object Invoke(Type scopingType, object scopingKey, ParameterCollection parameters)
        {
            ...
            if (scopingKey == null)
            {
                if (parameters.TryGet("target", out IdentifiedData targetEntity))
                {
                    ...
                    var distinctResults = results.GroupBy(o => o.Record.Key).Select(o => o.OrderByDescending(m => m.Strength).First()).OrderByDescending(o=>o.Strength).Skip(offset).Take(count);
