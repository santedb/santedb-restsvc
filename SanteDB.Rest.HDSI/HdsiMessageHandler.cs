...
namespace SanteDB.Rest.HDSI
{
    ...
    [ApiServiceProvider("Health Data Services Interface", typeof(HdsiServiceBehavior), ServiceEndpointType.HealthDataService, Configuration = typeof(HdsiConfigurationSection), Required = true)]
